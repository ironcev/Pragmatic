...
namespace TinyDdd.Tests.Unit.Interaction
{
    ...
    public class QueryExecutorTests
    {
        ...
        [Test]
        public void Execute_QueryHandlerWithValidResultType_ResultReturned()
        {
            var response = new QueryExecutorWithQueryHandlerWithValidQueryType().Execute(new TestResultQuery());
        ...
        private class QueryExecutorWithQueryHandlerWithValidQueryType : QueryExecutor
        {
            protected override IEnumerable<IQueryHandler> GetQueryHandlers(Type queryType, Type queryResultType)
            {
